...
public class GroupChatActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        findViewById(R.id.ib_img).setOnClickListener(v -> { //加号 不用点击发送直接发
    ...
    private void initSocket() {
        ...
        SocketUtil.emit(mSocket, "join_group", joinInfo);//this.user_name = user_name this.group_name = group_name;
    }

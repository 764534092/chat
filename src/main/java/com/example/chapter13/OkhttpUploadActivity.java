...
public class OkhttpUploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_face.setOnClickListener(v -> {
            ...
            startActivityForResult(albumIntent, CHOOSE_CODE); // 打开系统相册  这个方法必须写onActivityResult回掉方法！
        });
        findViewById(R.id.btn_register).setOnClickListener(v -> uploadFile());
    }

    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) { //和Intent有关
    ...
    private void uploadFile() {
        ...
        RequestBody body = builder.build(); // 根据建造器生成请求结构 //以前是FormBody FormBody body = new FormBody.Builder()

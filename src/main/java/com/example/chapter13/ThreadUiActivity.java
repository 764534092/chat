...
public class ThreadUiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_stop).setOnClickListener(v -> isPlaying = false);  //.setOnClickListener(this); onClick（View v）{}
    }
...
//        });
        ...
        // 回到主线程（UI线程）操纵界面  2
        runOnUiThread(() -> tv_message.setText(startDesc)); //内部还是有Handle的

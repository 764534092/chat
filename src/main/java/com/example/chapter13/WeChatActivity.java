...
public class WeChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_we_chat);//忘记写这句话了你妈的你妈的尼玛的 你妈的
        initView(); // 初始化视图
        mSocket = MainApplication.getInstance().getSocket(); // 定义URL
    ...
    private void initView() {
        ...
        // 构建一个翻页适配器
        WeChatAdapter adapter = new WeChatAdapter(getSupportFragmentManager()); //item(Fragment inflate)+数据()
...
//Attempt to invoke virtual method 'void androidx.viewpager.widget.ViewPager.setAdapter(androidx.viewpager.widget.PagerAdapter)' on a null object reference
        ...
        //ViewPager和RadioGroup交互 实现底部可滑动屏幕的底部导航栏
